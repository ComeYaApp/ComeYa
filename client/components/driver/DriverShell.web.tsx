...
const NAV: NavItem[] = [
  ...
  {
    id: "deliveries_active" as DriverSection, label: "Mis entregas", icon: "truck", color: "#3B82F6",
    children: [
  ...
  {
    id: "earnings_stats" as DriverSection, label: "Ganancias", icon: "trending-up", color: "#F59E0B",
    children: [
...
export function DriverShell({ active, onChange, isOnline, onToggleOnline, togglingOnline, children }: Props) {
    ...
    <View style={[sh.root, { backgroundColor: bg }]}>
      ...
      <View style={[sh.sidebar, { backgroundColor: sideBg, borderRightColor: border }]}>
        ...
        <View style={[sh.logoRow, { borderBottomColor: border }]}>
          ...
          <View style={[sh.statusDot, { backgroundColor: isOnline ? "#10B981" : "#6B7280" }]} />
        </View>
        ...
        {/* Online toggle */}
        <View style={[sh.onlineRow, {
          backgroundColor: isOnline ? "#16A34A10" : inputBg,
          borderBottomColor: border,
        }]}>
          <View style={[sh.onlinePulse, { backgroundColor: isOnline ? GREEN : "#9ca3af" }]} />
          <Text style={[sh.onlineTxt, { color: isOnline ? GREEN : sub, flex: 1 }]}>
            ...
            return (
              <View key={item.id}>
                ...
                >
                  ...
                  {hasChildren && (
                    <Feather name={isOpen ? "chevron-down" : "chevron-right"} size={13} color={sub} />
                  )}
                </Pressable>
...
const sh = StyleSheet.create({
  ...
  logoBadge:   { width: 34, height: 34, borderRadius: 10, backgroundColor: ACCENT, justifyContent: "center", alignItems: "center" },
  ...
  onlineRow:   { flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 16, paddingVertical: 10, borderBottomWidth: 1 },
