...
const DOCS: DocUpload[] = [
  {
    ...
    icon: "camera",
    color: BLUE,
    hint: "Foto clara de la matrícula del vehículo",
    required: true,
  },
  {
    label: "ITV en vigor",
    ...
    icon: "check-square",
    color: GREEN,
    hint: "Foto del documento ITV vigente (motos y coches)",
    required: false,
  },
  {
    ...
    icon: "shield",
    color: PURPLE,
    hint: "Foto de la póliza o recibo del seguro en vigor",
    required: false,
  },
  {
    ...
    icon: "credit-card",
    color: AMBER,
    hint: "Foto del carnet de conducir (anverso y reverso en 1 imagen)",
    required: false,
  },
];
...
export function DriverVehicleTab() {
  ...
  const handleDocUpload = async (key: string, file: File) => {
    ...
    try {
      ...
      flash(false, "Error al cargar imagen");
    } finally {
      setUploading(null);
    }
  };
  ...
  const handleSave = async () => {
    if (!vehicleType) {
      flash(false, "Selecciona el tipo de vehículo");
      return;
    }
    if (!plate.trim()) {
      flash(false, "La matrícula es obligatoria");
      return;
    }
    if (!docs.platePhoto) {
      flash(false, "La foto de matrícula es obligatoria");
      return;
    }
    ...
    <View style={[s.root, { backgroundColor: bg }]}>
      ...
      >
        ...
        <Text style={[s.subtitle, { color: sub }]}>
          Datos y documentación del vehículo de reparto
        </Text>
      </View>
      ...
      >
            ...
            {VEHICLE_TYPES.map((v) => {
              ...
              return (
                ...
                >
                  ...
                  <Text style={[s.typeLabel, { color: active ? GREEN : text }]}>
                    {v.label}
                  </Text>
                  <Text style={[s.typeSub, { color: sub }]}>
                    Carnet: {v.license}
                  </Text>
          ...
          {selectedType && (
            ...
            >
              ...
              <Text style={[s.typeInfoTxt, { color: text }]}>
                ...
                · ITV:{" "}
                <Text style={{ fontWeight: "700" }}>{selectedType.itv}</Text>
        ...
        <View style={[s.card, { backgroundColor: card, borderColor: border }]}>
          ...
          <View style={s.field}>
            <Text style={[s.fieldLabel, { color: sub }]}>
              MATRÍCULA <Text style={{ color: RED }}>*</Text>
            </Text>
            <TextInput
              style={
                [
            ...
            />
            <Text style={[s.fieldHint, { color: sub }]}>
              Formato español: 4 dígitos + 3 letras (ej: 1234 ABC)
            </Text>
          </View>
        ...
        <View style={[s.card, { backgroundColor: card, borderColor: border }]}>
          ...
          <Text style={[s.sectionSub, { color: sub }]}>
            Sube fotos claras de los documentos. Serán revisados por el equipo
            de ComeYa antes de activar tu cuenta.
          </Text>
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  <View style={s.docTitleRow}>
                    ...
                    {hasDoc && (
                      <View
                        style={[s.reqBadge, { backgroundColor: GREEN + "15" }]}
                      >
                ...
                <TouchableOpacity
                  ...
                  style={[
                    s.docBtn,
                    {
                      backgroundColor: hasDoc ? GREEN + "15" : doc.color + "15",
                ...
                >
                  ...
                  <Text
                    style={[s.docBtnTxt, { color: hasDoc ? GREEN : doc.color }]}
                  >
        ...
        >
          ...
          <Text style={[s.legalTxt, { color: text }]}>
            ...
            Toda la documentación debe estar en vigor. ComeYa puede suspender tu
            cuenta si se detecta documentación caducada o falsa. En caso de
            accidente, el seguro del vehículo es responsabilidad exclusiva del
            repartidor.
          </Text>
        </View>
