    ...
    <View style={tabStyles.container}>
      <View style={tabStyles.sectionTabs}>
        {(["all", "open", "closed"] as const).map((f) => (
          <Pressable
            ...
            onPress={() => setFilter(f)}
            style={[
              tabStyles.sectionTab,
              filter === f && { backgroundColor: ComeYaColors.primary },
            ]}
          >
            <ThemedText
              type="small"
              style={{ color: filter === f ? "#fff" : theme.text }}
            >
      ...
      {filteredTickets.length === 0 ? (
        ...
        filteredTickets.map((ticket) => (
          <View
            key={ticket.id}
            style={[tabStyles.card, { backgroundColor: theme.card }]}
          >
