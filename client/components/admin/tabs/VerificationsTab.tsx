              ...
              >
                ...
                <View style={{ flex: 1, marginLeft: 12 }}>
                  ...
                  <View style={{ flexDirection: "row", gap: 6, marginTop: 4 }}>
                    <View
                      style={[s.badge, { backgroundColor: "#6366F1" + "20" }]}
                    >
                      <Text
                        style={{
                          color: "#6366F1",
                    ...
                    <View
                      style={[s.badge, { backgroundColor: cfg.color + "20" }]}
                    >
                      <Feather
              ...
              {selected && (
                <>
                  ...
                  <View style={s.sheetHeader}>
                    ...
                    <View style={{ flex: 1, marginLeft: 12 }}>
                      <Text
                        style={[s.name, { color: theme.text, fontSize: 18 }]}
                      >
                        {selected.name}
                      </Text>
                      <Text style={[s.sub, { color: theme.textSecondary }]}>
                  ...
                  <Section title="Datos personales" theme={theme}>
                    ...
                    <Row
                      label="DNI/NIE"
                      value={selected.dni || "No proporcionado"}
                      theme={theme}
                    />
                    <Row
                      label="Dirección"
                          ...
                          ["motorcycle", "car"].includes(
                            ...
                            <>
                              <Row
                                label="Matrícula"
                                value={
                                  selected.deliveryDriver.vehiclePlate ||
                                  "No proporcionada"
                                }
                                theme={theme}
                              />
                              <Row
                                label="Marca"
                                value={
                                  selected.deliveryDriver.vehicleBrand ||
                                  "No proporcionada"
                                }
                                theme={theme}
                              />
                              <Row
                                label="Modelo"
                                value={
                                  selected.deliveryDriver.vehicleModel ||
                                  "No proporcionado"
                                }
                                theme={theme}
                              />
                              <Row
                                label="Color"
                                value={
                                  selected.deliveryDriver.vehicleColor ||
                                  "No proporcionado"
                                }
                                theme={theme}
                              />
                  ...
                  {selected.role === "business_owner" && selected.business && (
                    <Section title="Información del negocio" theme={theme}>
                      <Row
                        label="Nombre"
                        value={selected.business.name || "No proporcionado"}
                        theme={theme}
                      />
                      <Row
                        label="Tipo"
                        value={selected.business.type || "No especificado"}
                        theme={theme}
                      />
                      <Row
                        label="Dirección"
                        value={selected.business.address || "No proporcionada"}
                        theme={theme}
                      />
                      <Row
                        label="Teléfono"
                        value={selected.business.phone || "No proporcionado"}
                        theme={theme}
                      />
                    </Section>
                  )}
...
function DocBadge({ label, has, theme }: any) {
  return (
    <View
      style={[
        s.badge,
        { backgroundColor: has ? "#10B981" + "20" : "#F59E0B" + "20" },
      ]}
    >
      <Feather
        name={has ? "file-text" : "alert-circle"}
        size={10}
        color={has ? "#10B981" : "#F59E0B"}
      />
      <Text
        style={{
          color: has ? "#10B981" : "#F59E0B",
