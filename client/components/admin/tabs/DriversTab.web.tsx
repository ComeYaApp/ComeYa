...
export const DriversTab: React.FC<Props> = () => {
  ...
  useEffect(() => {
    ...
    if (filter === "offline")
      list = list.filter((d) => !d.isOnline && !d.isBlocked);
  ...
  const FILTERS = [
    ...
    { id: "online", label: "En línea", count: onlineCount, color: "#10B981" },
    {
      id: "offline",
      label: "Offline",
      count: drivers.length - onlineCount - blockedCount,
      color: sub,
    },
    {
      id: "blocked",
              ...
              return (
                ...
                >
                  <View style={li.row}>
                    {/* Avatar */}
                    <View
                      style={[li.avatar, { backgroundColor: PURPLE + "20" }]}
                    >
                      ...
                      <View
                        style={[
                          li.onlineDot,
                          {
                            backgroundColor: driver.isBlocked
                              ? "#EF4444"
                              : driver.isOnline
                                ? "#10B981"
                                : "#9CA3AF",
                    ...
                    <View style={{ flex: 1 }}>
                      <View style={li.nameRow}>
                        ...
                        {driver.strikes > 0 && (
                          ...
                          >
                            <Text style={[li.strikeTxt, { color: "#F59E0B" }]}>
                              ⚡ {driver.strikes}
                            </Text>
                          </View>
                        )}
                    ...
                    <View style={li.right}>
                      ...
                      <Text style={[li.deliveries, { color: sub }]}>
