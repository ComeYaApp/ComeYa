...
const NAV: NavItem[] = [
  ...
  },
  {
    ...
    icon: "gift",
    color: "#EC4899",
    children: [{ id: "coupons", label: "Cupones", icon: "tag" }],
  },
  {
    id: "support",
    label: "Soporte",
      ...
      >
        ...
        <View style={[sh.userRow, { borderBottomColor: border }]}>
          ...
          <View style={{ flex: 1 }}>
            ...
            {user?.email ? (
              <Text style={[sh.userEmail, { color: sub }]} numberOfLines={1}>
                {user.email}
              </Text>
            ) : null}
          </View>
                  ...
                  item.children!.map((child) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {!!childBadge && (
                          <View
                            style={[sh.badge, { backgroundColor: item.color }]}
                          >
                            <Text style={sh.badgeTxt}>
