    ...
    >
      ...
      >
        ...
        <Text style={[s.infoText, { color: ComeYaColors.primary }]}>
          Tarifa por tramos segun distancia entre negocio y cliente. Soria es
          una ciudad pequena, maxima distancia ~8 km.
        </Text>
      </View>
      ...
      >
        <Text style={[s.previewTitle, { color: theme.text }]}>
          Vista previa
        </Text>
        {[1.5, 2.5, 3.5, 5, 6, 8].map((km) => (
          <View key={km} style={s.previewRow}>
            <Text style={[s.previewKm, { color: theme.textSecondary }]}>
              {km} km
            </Text>
      ...
      <TouchableOpacity
        style={[
          s.btn,
          { backgroundColor: ComeYaColors.primary, opacity: saving ? 0.7 : 1 },
        ]}
        onPress={save}
        disabled={saving}
      >
        {saving ? (
          ...
          <>
            ...
            <Text style={s.btnText}>Guardar tarifas</Text>
          </>
        )}
      </TouchableOpacity>
    </ScrollView>
