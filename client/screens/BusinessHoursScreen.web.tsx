...
export default function BusinessHoursScreen() {
  ...
  const updateShift = (
    ...
    setHours((prev) =>
      prev.map((h, idx) =>
        idx === i ? { ...h, [shift]: { ...h[shift], [field]: value } } : h,
      ),
    );
  ...
  const TimeBtn = ({
    ...
    <Pressable
      onPress={onPress}
      style={[s.timeBtn, { backgroundColor: inputBg, borderColor: border }]}
    >
      ...
      >
        ...
        {loadingBusinesses ? (
          ...
          <View
            style={[
              s.businessSelector,
              { backgroundColor: card, borderColor: border, marginBottom: 20 },
            ]}
          >
            <Text style={[s.businessSelectorLabel, { color: sub }]}>
        ...
        >
          ...
          >
            {saving ? (
              ...
              <Text style={s.saveBtnText}>Guardar horarios</Text>
            )}
          </Pressable>
        </View>
        {loading ? (
          ...
          >
            ...
            <input
              ...
              style={{
                fontSize: 28,
                fontWeight: "700",
                border: `2px solid ${ComeYaColors.primary}`,
                borderRadius: 10,
                padding: "8px 16px",
                color: text,
            ...
            <View style={s.timeGrid}>
              {[
                ...
                <Pressable
                  key={t}
                  onPress={() => setPickerValue(t)}
                  style={[
                    s.timeOption,
                    {
                      backgroundColor:
                        pickerValue === t ? ComeYaColors.primary : inputBg,
                    },
                  ]}
                >
                  <Text
            ...
            <View style={s.pickerBtns}>
              <Pressable
                ...
                style={[s.pickerBtn, { borderColor: border, borderWidth: 1 }]}
              >
                <Text style={{ color: text }}>Cancelar</Text>
              </Pressable>
              <Pressable
                onPress={confirmPicker}
                style={[s.pickerBtn, { backgroundColor: ComeYaColors.primary }]}
              >
