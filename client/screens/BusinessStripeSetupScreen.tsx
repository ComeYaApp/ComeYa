        ...
        >
          <View style={styles.statusHeader}>
            ...
            <View style={styles.statusInfo}>
              ...
              <ThemedText
                type="h3"
                style={{ color: getStatusColor(), marginTop: 4 }}
              >
                {getStatusText()}
              </ThemedText>
            </View>
          ...
          {stripeStatus.connected && (
            <View style={styles.statusDetails}>
              <View style={styles.statusRow}>
                <Feather
                  name={
                    stripeStatus.chargesEnabled ? "check-circle" : "x-circle"
                  }
                  size={18}
                  color={
              ...
              <View style={styles.statusRow}>
                <Feather
                  name={
                    stripeStatus.payoutsEnabled ? "check-circle" : "x-circle"
                  }
                  size={18}
                  color={
            ...
            >
              ...
              <View style={{ flex: 1, marginLeft: Spacing.md }}>
                ...
                <ThemedText type="small" style={{ color: theme.textSecondary }}>
                  Para recibir pagos de tus ventas, necesitas conectar tu cuenta
                  de Stripe Connect.
                </ThemedText>
              </View>
            </View>
