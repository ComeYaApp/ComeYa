...
export default function PrivacyScreen() {
  ...
  const InfoBox = ({
    ...
    <View
      style={[styles.infoBox, { backgroundColor: ComeYaColors.primary + "10" }]}
    >
      <View style={styles.infoHeader}>
        <Feather name={icon as any} size={20} color={ComeYaColors.primary} />
        <ThemedText
          type="body"
          style={[styles.infoTitle, { color: ComeYaColors.primary }]}
        >
          {title}
        </ThemedText>
      </View>
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      >
        ...
        <Paragraph>
          En ComeYa, la protección de su privacidad y datos personales es
          nuestra máxima prioridad. Esta Política de Privacidad describe cómo
          recopilamos, usamos, almacenamos, compartimos y protegemos su
          información personal de conformidad con el Reglamento General de
          Protección de Datos (GDPR) y las leyes españolas aplicables.
        </Paragraph>
        ...
        <Section title="1. Responsable del Tratamiento">
          ...
          <BulletPoint>
            Delegado de Protección de Datos: dpo@comeya.app
          </BulletPoint>
        </Section>
        ...
        <Section title="2. Información que Recopilamos">
          ...
          <BulletPoint>
            Número de teléfono móvil (verificado por SMS/OTP)
          </BulletPoint>
          ...
          <BulletPoint>
            Preferencias de productos y negocios favoritos
          </BulletPoint>
          ...
          <BulletPoint>
            Ubicación GPS en tiempo real durante entregas activas
          </BulletPoint>
          ...
          <BulletPoint>
            Información de tarjetas (procesada y almacenada por Stripe, no por
            ComeYa)
          </BulletPoint>
          <BulletPoint>Historial de transacciones</BulletPoint>
          <BulletPoint>
            Datos bancarios para retiros (negocios y repartidores)
          </BulletPoint>
        ...
        <Section title="3. Base Legal y Finalidad del Tratamiento">
          <InfoBox icon="file-text" title="Ejecución de Contrato">
            <Paragraph>
              Procesamos sus datos para proporcionar nuestros servicios:
              procesar pedidos, coordinar entregas, gestionar pagos y
          ...
          <InfoBox icon="shield" title="Obligación Legal">
            <Paragraph>
              Cumplimiento de obligaciones fiscales, contables y de prevención
              de fraude según la legislación española.
            </Paragraph>
          </InfoBox>

          <InfoBox icon="check-circle" title="Consentimiento">
            <Paragraph>
              Marketing, notificaciones promocionales y análisis de
              comportamiento (puede retirar su consentimiento en cualquier
              momento).
            </Paragraph>
          </InfoBox>
          ...
          <InfoBox icon="alert-circle" title="Interés Legítimo">
            <Paragraph>
              Mejora de servicios, prevención de fraude, seguridad de la
              plataforma y análisis estadísticos.
            </Paragraph>
          </InfoBox>
        </Section>
        ...
        <Section title="4. Cómo Usamos su Información">
          <BulletPoint>
            Procesar y gestionar pedidos de principio a fin
          </BulletPoint>
          <BulletPoint>
            Conectar usuarios con negocios y repartidores apropiados
          </BulletPoint>
          <BulletPoint>
            Calcular tarifas de entrega basadas en distancia
          </BulletPoint>
          ...
          <BulletPoint>
            Enviar notificaciones sobre estado de pedidos
          </BulletPoint>
        ...
        <Section title="5. Compartir Información con Terceros">
          ...
          <BulletPoint>
            Negocio: Nombre del cliente, dirección de entrega, teléfono,
            detalles del pedido
          </BulletPoint>
          <BulletPoint>
            Repartidor: Nombre del cliente, dirección de entrega, teléfono,
            instrucciones
          </BulletPoint>
          <BulletPoint>
            Cliente: Nombre del repartidor, foto, ubicación GPS en tiempo real,
            teléfono
          </BulletPoint>
          ...
          <BulletPoint>
            Stripe: Procesamiento de pagos (PCI-DSS Level 1 certificado)
          </BulletPoint>
          <BulletPoint>Twilio: Verificación SMS y comunicaciones</BulletPoint>
          <BulletPoint>
            Google Maps: Servicios de geolocalización y navegación
          </BulletPoint>
          <BulletPoint>
            Servicios de hosting: Almacenamiento seguro de datos (servidores en
            UE)
          </BulletPoint>
          <BulletPoint>
            Servicios de analytics: Análisis de uso (datos anonimizados)
          </BulletPoint>
        ...
        <Section title="6. Seguridad de Datos">
          <Paragraph>
            Implementamos medidas técnicas y organizativas de seguridad de nivel
            industrial:
          </Paragraph>
          <ThemedText
            type="body"
        ...
        <Section title="7. Sus Derechos (GDPR)">
          <Paragraph>
            Bajo el GDPR y la legislación española, usted tiene los siguientes
            derechos:
          </Paragraph>
          <BulletPoint>
            Derecho de Acceso: Obtener copia de sus datos personales
          </BulletPoint>
          <BulletPoint>
            Derecho de Rectificación: Corregir datos inexactos o incompletos
          </BulletPoint>
          <BulletPoint>
            Derecho de Supresión: Solicitar eliminación de sus datos ("derecho
            al olvido")
          </BulletPoint>
          <BulletPoint>
          ...
          <BulletPoint>
            Derecho de Portabilidad: Recibir sus datos en formato estructurado y
            legible
          </BulletPoint>
          <BulletPoint>
          ...
          <BulletPoint>
            Derecho a Retirar Consentimiento: En cualquier momento, sin afectar
            la legalidad del procesamiento previo
          </BulletPoint>
          <BulletPoint>
            Derecho a Presentar Reclamación: Ante la Agencia Española de
        ...
        <Section title="8. Retención de Datos">
          ...
          <BulletPoint>
            Cuenta activa: Mientras su cuenta esté activa y funcional
          </BulletPoint>
          <BulletPoint>
            Historial de pedidos: 7 años (requisito fiscal español)
          </BulletPoint>
          <BulletPoint>
            Datos de pago: Según requisitos de Stripe y regulaciones PCI-DSS
          </BulletPoint>
          <BulletPoint>
            Ubicación GPS: 30 días después de completar entrega
          </BulletPoint>
          ...
          <Paragraph>
            Después de estos períodos, los datos son eliminados de forma segura
            o anonimizados para análisis estadísticos.
          </Paragraph>
        </Section>

        <Section title="9. Transferencias Internacionales">
          <Paragraph>
            Sus datos se almacenan principalmente en servidores ubicados en la
            Unión Europea. Algunos proveedores de servicios pueden procesar
            datos fuera de la UE:
          </Paragraph>
          <BulletPoint>
            Stripe: USA (certificado Privacy Shield y cláusulas contractuales
            estándar)
          </BulletPoint>
          <BulletPoint>
            Google Cloud: Servidores en UE con garantías de protección adecuadas
          </BulletPoint>
          <Paragraph>
            Todas las transferencias internacionales cumplen con el Artículo 46
            del GDPR mediante cláusulas contractuales estándar aprobadas por la
            Comisión Europea.
          </Paragraph>
        </Section>
        ...
        <Section title="10. Cookies y Tecnologías de Seguimiento">
          ...
          <BulletPoint>
            Cookies esenciales: Necesarias para el funcionamiento de la
            plataforma
          </BulletPoint>
          <BulletPoint>
            Cookies de rendimiento: Análisis de uso y mejora de servicios
          </BulletPoint>
          <BulletPoint>
            Cookies de funcionalidad: Recordar preferencias y configuraciones
          </BulletPoint>
          <BulletPoint>
            Identificadores de dispositivo: Para seguridad y prevención de
            fraude
          </BulletPoint>
          <Paragraph>
            Puede gestionar sus preferencias de cookies en la configuración de
            la aplicación. Las cookies esenciales no pueden desactivarse sin
        ...
        <Section title="11. Privacidad de Menores">
          <Paragraph>
            ComeYa no está dirigido a menores de 18 años. No recopilamos
            intencionalmente información de menores. Si descubrimos que hemos
            recopilado datos de un menor sin consentimiento parental
            verificable, eliminaremos esa información inmediatamente.
          </Paragraph>
          <Paragraph>
            Si es padre o tutor y cree que su hijo nos ha proporcionado
            información personal, contáctenos en privacy@comeya.app.
          </Paragraph>
        </Section>
        ...
        <Section title="12. Privacidad por Rol">
          ...
          <Paragraph>
            Protegemos su información de pago, direcciones e historial de
            pedidos. Solo compartimos nombre y dirección de entrega con negocio
            y repartidor durante pedidos activos.
          </Paragraph>
          ...
          <Paragraph>
            Su ubicación GPS solo es visible para clientes durante entregas
            activas. Información de vehículo, documentos de identidad y
            ganancias son estrictamente confidenciales.
          </Paragraph>
          ...
          <Paragraph>
            Información bancaria encriptada. Métricas de ventas, productos y
            estrategias comerciales son privadas y no se comparten con
            competidores.
          </Paragraph>
        </Section>
        ...
        <Section title="13. Notificación de Brechas de Seguridad">
          <Paragraph>
            ...
            le notificaremos dentro de las 72 horas según lo requerido por el
            GDPR. La notificación incluirá:
          </Paragraph>
        ...
        <Section title="14. Cambios a esta Política">
          <Paragraph>
            ...
            reflejar cambios en nuestras prácticas o por razones legales. Los
            cambios materiales serán notificados con al menos 30 días de
          ...
          <Paragraph>
            Le recomendamos revisar esta política periódicamente. La fecha de
            "Última actualización" al inicio indica cuándo se realizó la última
            modificación.
          </Paragraph>
        </Section>
        ...
        <Section title="15. Contacto y Autoridad de Supervisión">
          ...
          <Paragraph>
            Si no está satisfecho con nuestra respuesta, tiene derecho a
        ...
        <View style={[styles.footer, { backgroundColor: theme.card }]}>
          ...
          >
            Su privacidad es nuestra prioridad. Cumplimos con GDPR y todas las
