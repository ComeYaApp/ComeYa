...
export default function AdminMenuScreen({ route }: { route?: any }) {
  ...
  const handleDashboardOrderPress = (order: ActiveOrder) => {
    const mappedOrder: AdminOrder = {
      ...
      paymentMethod: "card",
      deliveryAddress:
        order.deliveryAddress?.address || "Dirección no disponible",
  ...
  const handleDashboardDriverPress = (driver: OnlineDriver) => {
    ...
    const fallback = {
      ...
      createdAt:
        existing?.createdAt || driver.lastActiveAt || new Date().toISOString(),
    };
          ...
          <DashboardTab
            ...
            navigation={{
              navigate: (screen: string) =>
                setActiveTab(screen === "MapView" ? "map" : screen),
            }}
          />
        );
      case "drivers":
                ...
                <View style={[styles.modalCard, { backgroundColor: theme.card }]}>
                  ...
                  >
                    ...
                    <Pressable onPress={() => setUserModalVisible(false)}>
                      <ThemedText style={{ fontSize: 24, color: "#666" }}>
                        ✕
                      </ThemedText>
                    </Pressable>
                  </View>
                            ...
                            style={{
                              color:
                                userRoleEdit === role.key
                                  ...
                                  : theme.text,
                              fontWeight:
                                userRoleEdit === role.key ? "bold" : "normal",
                              fontSize: 14,
                            }}
                          >
                            {role.label}
        ...
        return (
          <View style={{ flex: 1 }}>
            <CouponsTab
              theme={theme}
              showToast={showToast}
              onSelectCoupon={handleCouponPress}
            />
                    ...
                    <View style={{ alignItems: "center", marginBottom: 20 }}>
                      ...
                      <View style={{ width: "100%", marginBottom: 15 }}>
                        ...
                        <TextInput
                          ...
                          onChangeText={(text) =>
                            setSelectedCoupon({ ...selectedCoupon, code: text })
                          }
                      ...
                      <View style={{ width: "100%", marginBottom: 15 }}>
                        ...
                        <TextInput
                          ...
                          onChangeText={(text) =>
                            setSelectedCoupon({
                              ...selectedCoupon,
                              discountValue: parseFloat(text) || 0,
                            })
                          }
                          placeholder="20"
                          placeholderTextColor={theme.textSecondary}
                        ...
                        <TextInput
                          ...
                          value={
                            selectedCoupon.minOrderAmount
                              ? (selectedCoupon.minOrderAmount / 100).toString()
                              : ""
                          }
                          onChangeText={(text) =>
                            setSelectedCoupon({
                              ...selectedCoupon,
                              minOrderAmount: parseFloat(text) * 100 || null,
                            })
                          }
                          placeholder="100"
                          placeholderTextColor={theme.textSecondary}
                    ...
                    >
                      <Pressable
                        ...
                        style={{
                          ...
                          paddingHorizontal: 20,
                          borderRadius: 25,
                          backgroundColor: selectedCoupon.isActive
                            ? "#10B981"
                            : theme.backgroundSecondary,
                          borderWidth: 1,
                          borderColor: selectedCoupon.isActive
                            ? "#10B981"
                            : theme.border,
                          flex: 1,
                          alignItems: "center",
                      ...
                      >
                        <ThemedText
                          style={{
                            color: selectedCoupon.isActive
                              ? "white"
                              : theme.text,
                            fontWeight: selectedCoupon.isActive
                              ? "bold"
                              : "normal",
                          }}
                        >
                  ...
                  <ScrollView showsVerticalScrollIndicator={false}>
                    <View style={{ alignItems: "center", marginBottom: 20 }}>
                      ...
                      <View style={{ width: "100%", marginBottom: 15 }}>
                        ...
                        <TextInput
                          ...
                          onChangeText={(text) =>
                            setSelectedZone({ ...selectedZone, name: text })
                          }
                        ...
                        <TextInput
                          ...
                          value={
                            selectedZone.deliveryFee
                              ? (selectedZone.deliveryFee / 100).toString()
                              : ""
                          }
                          onChangeText={(text) =>
                            setSelectedZone({
                              ...selectedZone,
                              deliveryFee: parseFloat(text) * 100 || 0,
                            })
                          }
                          placeholder="3.00"
                          placeholderTextColor={theme.textSecondary}
                      ...
                      <View style={{ width: "100%", marginBottom: 15 }}>
                        ...
                        <TextInput
                          ...
                          onChangeText={(text) =>
                            setSelectedZone({
                              ...selectedZone,
                              maxDeliveryTime: parseInt(text) || 0,
                            })
                          }
                          placeholder="30"
                          placeholderTextColor={theme.textSecondary}
                    ...
                    >
                      ...
                      <ThemedText style={{ marginBottom: 5 }}>
                        Radio:{" "}
                        <ThemedText style={{ fontWeight: "bold" }}>
                          {selectedZone.radiusKm || 0} km
                        </ThemedText>
                      </ThemedText>
                      <ThemedText style={{ marginBottom: 5 }}>
                        Coordenadas:{" "}
                        <ThemedText style={{ fontWeight: "bold" }}>
                          {selectedZone.centerLatitude || "N/A"},{" "}
                          {selectedZone.centerLongitude || "N/A"}
                        </ThemedText>
                      </ThemedText>
                      <ThemedText>
                        Creada:{" "}
                    ...
                    >
                      <Pressable
                        onPress={() =>
                          setSelectedZone({ ...selectedZone, isActive: true })
                        }
                        style={{
                          paddingVertical: 12,
                          paddingHorizontal: 20,
                          borderRadius: 25,
                          backgroundColor: selectedZone.isActive
                            ? "#10B981"
                            : theme.backgroundSecondary,
                          borderWidth: 1,
                          borderColor: selectedZone.isActive
                            ? "#10B981"
                            : theme.border,
                          flex: 1,
                          alignItems: "center",
                      ...
                      >
                        <ThemedText
                          style={{
                            ...
                            fontWeight: selectedZone.isActive
                              ? "bold"
                              : "normal",
                          }}
                        >
                      ...
                      <Pressable
                        onPress={() =>
                          setSelectedZone({ ...selectedZone, isActive: false })
                        }
                        style={{
                          paddingVertical: 12,
                          paddingHorizontal: 20,
                  ...
                  >
                    ...
                    <ThemedText style={{ marginBottom: 4, color: theme.text }}>
                      ...
                      {log.entityId || log.entity_id
                        ? ` (${(log.entityId || log.entity_id).slice(0, 8)}...)`
                        : ""}
                    </ThemedText>
                    {log.changes && (
                      <ThemedText
