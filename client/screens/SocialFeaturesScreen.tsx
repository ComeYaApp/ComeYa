...
export default function SocialFeaturesScreen() {
  ...
  const joinGroupOrder = async (groupId: string) => {
    Alert.alert("Unirse al Grupo", "¿Quieres unirte a este pedido grupal?", [
    ...
    <ScrollView>
      ...
      {groupOrders.map((group) => (
        <View key={group.id} style={styles.groupCard}>
          <View style={styles.groupHeader}>
            ...
            <View
              style={[
                styles.statusBadge,
                {
                  backgroundColor: group.status === "open" ? "green" : "orange",
                },
              ]}
            >
          ...
          <Text style={styles.groupOrganizer}>
            👤 Organizado por {group.organizer}
          </Text>
            ...
            >
              <Text
                style={[
                  styles.likeIcon,
                  {
                    color: review.isLiked ? "red" : Colors.light.tabIconDefault,
                  },
                ]}
              >
                {review.isLiked ? "❤️" : "🤍"}
