...
const CUSTOMER_METHODS = [
  ...
  },
  {
    ...
    color: "#635BFF",
    desc: "Visa, Mastercard — gestionado por Stripe",
  },
  {
    id: "paypal",
    label: "PayPal",
  ...
  const loadAccounts = async () => {
    try {
      ...
      if (data.success) {
        ...
        prefill(data.accounts || [], activeMethod);
      }
    } catch {
    ...
    <View style={[s.root, { backgroundColor: bg }]}>
      ...
      >
        ...
        <Text style={[s.sideTitle, { color: text }]}>
          {isCustomer ? "Métodos de pago" : "Cuentas de cobro"}
        </Text>
        <Text style={[s.sideSub, { color: sub }]}>
          {isCustomer
            ? "Guarda tus preferencias para el checkout"
            : "ComeYa transferirá tus ganancias aquí"}
        </Text>
            ...
            return (
              <Pressable
                ...
                style={[
                  s.methodTab,
                  {
                    backgroundColor: isActive ? m.color + "15" : "transparent",
                    borderColor: isActive ? m.color : border,
                  },
                ]}
              >
                <Feather
                  name={m.icon}
                  size={18}
                  color={isActive ? m.color : sub}
                />
                <Text
                  style={[
                    s.methodTabText,
                    { color: isActive ? m.color : text },
                  ]}
                >
                  {m.label}
                </Text>
        ...
        {!isCustomer && (
          ...
          >
            ...
            <Text style={[s.stripeBtnText, { color: "#635BFF" }]}>
              Stripe Connect
            </Text>
          </Pressable>
        )}
          ...
          <>
            ...
            >
              ...
              <View style={{ flex: 1, marginLeft: 12 }}>
                <Text
                  style={[s.methodDescTitle, { color: activeConfig.color }]}
                >
                  {activeConfig.label}
                </Text>
                <Text style={[s.methodDescSub, { color: sub }]}>
                  {activeConfig.desc}
                </Text>
              </View>
            </View>
            ...
            >
                ...
                <View
                  style={[
                    s.stripeInfo,
                    {
                      ...
                      borderColor: "#635BFF" + "30",
                    },
                  ]}
                >
                  <Feather name="shield" size={32} color="#635BFF" />
                  <View style={{ flex: 1, marginLeft: 16 }}>
                    <Text style={[s.stripeInfoTitle, { color: "#635BFF" }]}>
                      Gestionado por Stripe
                    </Text>
                    <Text style={[s.stripeInfoSub, { color: sub }]}>
              ...
              <Pressable
                ...
                style={[
                  s.saveBtn,
                  {
                    backgroundColor: isTarjetaCliente
                      ? "#635BFF"
              ...
              >
                {saving ? (
                  ...
                  <Text style={s.saveBtnText}>
                    {isTarjetaCliente ? "Establecer como preferido" : "Guardar"}
                  </Text>
                )}
              </Pressable>
            </View>
                    ...
                    >
                      <View
                        style={[
                          ...
                          {
                            backgroundColor:
                              (m?.color || ComeYaColors.primary) + "15",
                          },
                        ]}
                      >
                        <Feather
                          name={m?.icon || "credit-card"}
                          size={18}
                          color={m?.color || ComeYaColors.primary}
                        />
                      </View>
                      <View style={{ flex: 1, marginLeft: 12 }}>
                        <Text style={[s.accMethod, { color: text }]}>
                          {m?.label || acc.method}
                        </Text>
                        <Text style={[s.accDetail, { color: sub }]}>
                          {detail || "—"}
                        </Text>
                      </View>
                      {acc.isDefault && (
