...
export default function BusinessProductsScreen() {
  ...
  const pickImage = () => {
    ...
    input.onchange = async (e: any) => {
      ...
      try {
        ...
        const r = await apiRequest("POST", "/api/business/product-image", {
          image: imageData,
        });
  ...
  const available = filtered.filter(
    (p) => p.isAvailable === 1 || p.isAvailable === true,
  );
      ...
      <View style={s.main}>
        ...
        >
          <View style={s.toolbarLeft}>
            ...
            {selectedBusiness && (
              <Pressable
                onPress={() => navigation.navigate("BusinessManage" as any)}
                style={[
                  s.bizChip,
                  {
              ...
              >
                <Text
                  style={[s.bizChipText, { color: ComeYaColors.primary }]}
                  numberOfLines={1}
                >
          ...
          <View style={s.toolbarRight}>
            ...
            >
              <Text style={[s.statChipValue, { color: ComeYaColors.success }]}>
                {available.length}
              </Text>
              <Text style={[s.statChipLabel, { color: ComeYaColors.success }]}>
                Disponibles
              </Text>
            </View>
            <View
            ...
            >
              <Text style={[s.statChipValue, { color: ComeYaColors.error }]}>
                {unavailable.length}
              </Text>
              <Text style={[s.statChipLabel, { color: ComeYaColors.error }]}>
                Agotados
              </Text>
            </View>
        ...
        >
          {loading ? (
            ...
            <View style={s.empty}>
              ...
              <Pressable
                onPress={openAdd}
                style={[s.emptyBtn, { backgroundColor: ComeYaColors.primary }]}
              >
            ...
            <>
              {unavailable.length > 0 && (
                <>
                  <View style={s.sectionHeader}>
                    ...
                    />
                    <Text
                      style={[s.sectionTitle, { color: ComeYaColors.error }]}
                    >
                      Agotados ({unavailable.length})
                    </Text>
                  </View>
              ...
              <View style={s.sectionHeader}>
                ...
                />
                <Text style={[s.sectionTitle, { color: ComeYaColors.success }]}>
        ...
        >
          ...
          >
            ...
            {[
              {
                key: "name",
                label: "Nombre *",
                placeholder: "Ej: Bocadillo de jamón",
              },
              {
                key: "description",
                label: "Descripción",
                ...
                <TextInput
                  style={[
                    s.input,
                    {
                      ...
                      color: text,
                      borderColor: border,
                      minHeight: f.key === "description" ? 80 : 48,
                    },
                  ]}
            ...
            <View style={s.formBtns}>
              ...
              <Pressable
                onPress={handleSave}
                style={[s.formBtn, { backgroundColor: ComeYaColors.primary }]}
              >
                <Text style={{ color: "#fff", fontWeight: "700" }}>
                  Guardar
                </Text>
...
function ProductCard({
  ...
  return (
    <View
      style={[
        pc.card,
        {
          ...
          borderColor: isAvailable ? border : ComeYaColors.error + "40",
          borderWidth: isAvailable ? 1 : 1.5,
    ...
    >
      ...
      />
      <View style={pc.info}>
        <Text style={[pc.name, { color: text }]} numberOfLines={1}>
          {product.name}
        </Text>
        <Text style={[pc.desc, { color: sub }]} numberOfLines={2}>
          {product.description}
        </Text>
