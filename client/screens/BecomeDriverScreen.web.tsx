...
export default function BecomeDriverScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (!vehiclePlate.trim()) {
      showToast("Ingresa la matrícula de tu vehículo", "error");
      return;
    }
    if (!profilePhoto) {
    ...
    if (!idPhoto) {
      showToast("Agrega foto de tu DNI/NIE", "error");
      return;
    }
    if (!vehiclePhoto) {
      ...
      <Pressable
        ...
        style={[
          s.photoBtn,
          {
            ...
            borderColor: photo ? ComeYaColors.success : border,
          },
        ]}
      >
        {photo ? (
        ...
        {photo && (
          <View
            style={[s.photoCheck, { backgroundColor: ComeYaColors.success }]}
          >
    ...
    <View style={[s.root, { backgroundColor: bg }]}>
      ...
      >
        ...
        >
          ...
          <Text style={[s.heroTitle, { color: ComeYaColors.primary }]}>
            Ser Repartidor
          </Text>
          <Text style={[s.heroSub, { color: sub }]}>
            Gana dinero entregando en Soria
          </Text>
        </View>
        ...
        <Text style={[s.sectionLabel, { color: sub, marginTop: 20 }]}>
          Requisitos
        </Text>
      ...
      >
        <Text style={[s.mainTitle, { color: text }]}>
            ...
            {VEHICLE_TYPES.map((v) => (
              <Pressable
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      vehicleType === v.id ? ComeYaColors.primary : inputBg,
                    borderColor:
                      vehicleType === v.id ? ComeYaColors.primary : border,
                  },
                ]}
              >
                <Feather
        ...
        <View style={[s.card, { backgroundColor: card, borderColor: border }]}>
          ...
          <PhotoUpload
            ...
            photo={profilePhoto}
            onPick={() => pickPhoto(setProfilePhoto)}
            required
          />
          <PhotoUpload
            label="DNI / NIE (frontal)"
            photo={idPhoto}
            onPick={() => pickPhoto(setIdPhoto)}
            required
          />
          <PhotoUpload
            label="Foto del vehículo"
            photo={vehiclePhoto}
            onPick={() => pickPhoto(setVehiclePhoto)}
            required
          />
        </View>
