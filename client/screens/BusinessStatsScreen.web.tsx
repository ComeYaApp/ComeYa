...
export default function BusinessStatsScreen() {
  ...
  const periodRevenue =
    { today: revenue.today, week: revenue.week, month: revenue.month }[
      period
    ] || 0;
  ...
  const STATS = [
    ...
    },
    {
      icon: "check-circle",
      label: "Completados",
      value: `${orders.completed} (${completionRate}%)`,
      color: "#4CAF50",
    },
    {
      icon: "x-circle",
          ...
          <>
            ...
            <View style={s.statsGrid}>
              {STATS.map((stat) => (
                ...
                >
                  <View
                    style={[s.statIcon, { backgroundColor: stat.color + "20" }]}
                  >
                    <Feather
            ...
            {topProducts.length > 0 && (
              ...
              >
                ...
                {topProducts.slice(0, 5).map((p: any, i: number) => (
                  ...
                  >
                    <View
                      style={[s.rankBadge, { backgroundColor: PRIMARY + "20" }]}
                    >
                      <Text style={[s.rankNum, { color: PRIMARY }]}>
                        {i + 1}
                      </Text>
                    </View>
                    <Text
