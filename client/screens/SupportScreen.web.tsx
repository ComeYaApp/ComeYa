        ...
        >
          <View style={[s.sideHeader, { borderBottomColor: border }]}>
            ...
            {openCount > 0 && (
              <View
                style={[
                  s.openBadge,
                  { backgroundColor: "#FF980020", borderColor: "#FF980040" },
                ]}
              >
          ...
          <View style={s.sideNav}>
            <Pressable
              ...
              style={[s.navItem, !showForm && s.navItemActive]}
            >
              <Feather
                name="list"
                size={18}
                color={!showForm ? PRIMARY : sub}
              />
              <Text
                style={[s.navItemText, { color: !showForm ? PRIMARY : text }]}
              >
                Mis tickets
              </Text>
            </Pressable>
        ...
        >
          {showForm ? (
            <>
              ...
              >
                <View
                  style={[s.chatPromoIcon, { backgroundColor: PRIMARY + "20" }]}
                >
                  <Feather name="zap" size={22} color={PRIMARY} />
                </View>
                <View style={{ flex: 1 }}>
                  <Text style={[s.chatPromoTitle, { color: PRIMARY }]}>
                    ¿Necesitas ayuda inmediata?
                  </Text>
                  <Text style={[s.chatPromoSub, { color: sub }]}>
              ...
              >
                ...
                <View style={s.formBtns}>
                  ...
                  >
                    <Text style={[s.cancelBtnText, { color: sub }]}>
                      Cancelar
                    </Text>
                  </Pressable>
                  <Pressable
            ...
            <>
              <View style={s.listHeader}>
                ...
                <Pressable
                  onPress={() => setShowForm(true)}
                  style={[s.newBtn, { backgroundColor: PRIMARY }]}
                >
              ...
              {isLoading ? (
                ...
                tickets.map((ticket) => (
                  ...
                  >
                    <View style={s.ticketTop}>
                      <View
                        style={[
                          ...
                          {
                            backgroundColor:
                              (STATUS_COLOR[ticket.status] || "#9E9E9E") + "20",
                          },
                        ]}
                      >
                        <View
                          style={[
                            ...
                            {
                              backgroundColor:
                                STATUS_COLOR[ticket.status] || "#9E9E9E",
                            },
                          ]}
                        />
                        <Text
                          style={[
                            s.statusText,
                            { color: STATUS_COLOR[ticket.status] || "#9E9E9E" },
                          ]}
                        >
                    ...
                    <Text style={[s.ticketSubject, { color: text }]}>
                      {ticket.subject}
                    </Text>
                    <Text style={[s.ticketCategory, { color: sub }]}>
