  ...
  const SidebarContent = (
    <View
      style={
        isMobile
          ? undefined
          : [s.sidebar, { backgroundColor: card, borderRightColor: border }]
      }
    >
      ...
      {FILTERS.map((f) => (
        <Pressable
          ...
          style={[
            s.sideItem,
            typeFilter === f.id && { backgroundColor: PRIMARY + "12" },
          ]}
        >
          <Text
            style={[
              s.sideItemText,
              { color: typeFilter === f.id ? PRIMARY : text },
            ]}
          >
            {f.label}
          </Text>
      ...
      {SORT.map((f) => (
        <Pressable
          ...
          style={[
            s.sideItem,
            sortBy === f.id && { backgroundColor: PRIMARY + "12" },
          ]}
        >
          <Feather
            name={
              f.id === "rating" ? "star" : f.id === "delivery" ? "zap" : "tag"
            }
            size={13}
            color={sortBy === f.id ? PRIMARY : sub}
          />
          <Text
            style={[
              s.sideItemText,
              { color: sortBy === f.id ? PRIMARY : text },
            ]}
          >
            {f.label}
          </Text>
      ...
      {hasActiveFilters && (
        ...
        >
          ...
          <Text style={[s.clearBtnText, { color: PRIMARY }]}>
            Limpiar filtros
          </Text>
        </Pressable>
      )}
  ...
  const MobileFilters = (
    ...
    >
      <ScrollView
        ...
        contentContainerStyle={s.mobileChips}
      >
        {FILTERS.map((f) => (
          <Pressable
            key={f.id}
            ...
            style={[
              s.chip,
              {
                backgroundColor: typeFilter === f.id ? PRIMARY : inputBg,
                borderColor: typeFilter === f.id ? PRIMARY : border,
              },
            ]}
          >
            <Text
        ...
        {SORT.map((f) => (
          <Pressable
            ...
            style={[
              s.chip,
              {
                backgroundColor: sortBy === f.id ? PRIMARY + "18" : inputBg,
                borderColor: sortBy === f.id ? PRIMARY : border,
              },
            ]}
          >
            <Feather
            ...
            />
            <Text
              style={[s.chipText, { color: sortBy === f.id ? PRIMARY : text }]}
            >
              {f.label}
            </Text>
          </Pressable>
      ...
      >
        ...
        >
          ...
          <TextInput
            ...
            placeholder={
              isMobile ? "Buscar..." : "Buscar restaurantes o platos..."
            }
        ...
        >
          ...
          >
            <View style={[s.drawerHeader, { borderBottomColor: border }]}>
              ...
              <Pressable
                onPress={() => setDrawerOpen(false)}
                style={[s.drawerClose, { backgroundColor: bg }]}
              >
        ...
        >
          ...
          {!search && typeFilter === "all" && !activeCategory && (
            <View
              style={[
                s.hero,
                { marginBottom: 20, padding: isMobile ? 20 : 28 },
              ]}
            >
              <View style={{ flex: 1 }}>
                <Text style={[s.heroTitle, { fontSize: isMobile ? 18 : 24 }]}>
              ...
              {filtered.map((b) => (
                <View key={b.id} style={[s.cardWrap, cardStyle]}>
                  ...
                  <View style={[s.cardBody, { padding: isMobile ? 12 : 14 }]}>
                    <Text
                      style={[s.cardName, { color: text }]}
                      numberOfLines={1}
                    >
                      {b.name}
                    </Text>
                    <Text
                      style={[s.cardDesc, { color: sub }]}
                      numberOfLines={1}
                    >
                      {b.description || b.categories.join(" · ")}
                    </Text>
                    <View style={s.cardMeta}>
                      <Feather name="star" size={12} color="#FFB800" />
                      <Text style={[s.metaText, { color: text }]}>
                        {b.rating > 0 ? b.rating.toFixed(1) : "Nuevo"}
                      </Text>
