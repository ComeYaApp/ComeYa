...
const TIERS = [
  {
    key: "tier1",
    label: "Tramo 0 – 2 km",
    hint: "Entregas muy cercanas dentro del centro",
    icon: "map-pin",
    color: "#10B981",
  },
  {
    key: "tier2",
    label: "Tramo 2 – 3 km",
    hint: "Distancia media, barrios próximos",
    icon: "navigation",
    color: "#3B82F6",
  },
  {
    key: "tier3",
    label: "Tramo 3 – 4 km",
    hint: "Distancia larga, periferia de la ciudad",
    icon: "truck",
    color: "#F59E0B",
  },
  {
    key: "extraPerKm",
    label: "Extra por km (> 4 km)",
    hint: "Se suma por cada km adicional a partir de 4 km",
    icon: "plus",
    color: "#EF4444",
  },
];
  ...
  return (
    ...
    >
      ...
      <View style={hd.row}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={[hd.sub, { color: sub }]}>
            Costes de envío por tramos de distancia · Soria, España
          </Text>
        </View>
      </View>
      ...
      <View
        style={[
          hd.info,
          { backgroundColor: CYAN + "10", borderColor: CYAN + "30" },
        ]}
      >
        <Feather name="info" size={13} color={CYAN} />
        <Text style={[hd.infoTxt, { color: CYAN }]}>
          Soria es una ciudad compacta (~8 km máximo). Las tarifas se aplican
          según la distancia en línea recta entre el negocio y la dirección de
          entrega.
        </Text>
      </View>
      ...
      <View style={lay.cols}>
        ...
        <View style={{ flex: 1, gap: 12 }}>
          <Text style={[lay.sectionTitle, { color: sub }]}>
            ...
            return (
              ...
              >
                <View style={ti.header}>
                  ...
                  <View style={{ flex: 1 }}>
                    <Text style={[ti.label, { color: text }]}>
                      {tier.label}
                    </Text>
          ...
          <TouchableOpacity
            ...
            style={[
              btn.save,
              { backgroundColor: saved ? "#10B981" : saving ? sub : PRIMARY },
            ]}
          >
            {saving ? (
        ...
        <View style={[pv.card, { backgroundColor: card, borderColor: border }]}>
          <View style={pv.header}>
            ...
            <Text style={[pv.title, { color: text }]}>
          ...
          >
            ...
            <Text style={[pv.noteTxt, { color: sub }]}>
              La distancia se calcula en línea recta (Haversine) entre el
