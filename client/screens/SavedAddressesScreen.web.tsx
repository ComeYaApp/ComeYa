        ...
        >
          ...
          {loading ? (
            ...
            >
              ...
              <Pressable
                onPress={() => navigation.navigate("AddAddress")}
                style={[s.addBtn, { backgroundColor: PRIMARY, marginTop: 20 }]}
              >
                <Feather name="plus" size={16} color="#fff" />
            ...
            addresses.map((addr) => (
              <View
                ...
                style={[
                  s.addrCard,
                  {
                    ...
                    borderColor: addr.isDefault ? PRIMARY : border,
                    borderWidth: 1.5,
                    borderRadius: 16,
                  },
                ]}
              >
                <View style={s.addrHeader}>
                  <View
                    style={[s.addrIcon, { backgroundColor: PRIMARY + "15" }]}
                  >
                    <Feather
                      name={
                        addr.label === "Casa"
                  ...
                  <View style={{ flex: 1, marginLeft: 12 }}>
                    <Text style={[s.addrLabel, { color: text }]}>
                      {addr.label}
                    </Text>
                    <Text style={[s.addrStreet, { color: sub }]}>
                      {addr.street}
                    </Text>
                ...
                <View style={[s.addrActions, { borderTopColor: border }]}>
                  <Pressable
                    onPress={() =>
                      navigation.navigate("AddAddress", { address: addr })
                    }
                    style={s.actionBtn}
                  >
                    <Feather name="edit-2" size={14} color={PRIMARY} />
                    <Text style={[s.actionBtnText, { color: PRIMARY }]}>
                      Editar
                    </Text>
                  </Pressable>
                  {!addr.isDefault && (
