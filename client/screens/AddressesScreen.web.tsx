            ...
            addresses.map((addr) => (
              <View
                ...
                style={[
                  ...
                  {
                    backgroundColor: card,
                    borderColor: addr.isDefault ? ComeYaColors.primary : border,
              ...
              >
                <View style={s.addrHeader}>
                  ...
                  >
                    ...
                    />
                    <Text
                      style={[s.labelText, { color: ComeYaColors.primary }]}
                    >
                      {addr.label}
                    </Text>
                  </View>
                  {addr.isDefault && (
                    ...
                    >
                      <Text
                        style={[s.defaultText, { color: ComeYaColors.success }]}
                      >
                        Predeterminada
                      </Text>
                    </View>
                ...
                <Text style={[s.addrStreet, { color: text }]}>
                  {addr.street}
                </Text>
                <Text style={[s.addrCity, { color: sub }]}>
                ...
                <View style={s.addrActions}>
                  {!addr.isDefault && (
                    ...
                    >
                      ...
                      />
                      <Text
                        style={[s.actionText, { color: ComeYaColors.primary }]}
                      >
                        Predeterminada
                      </Text>
                    </Pressable>
                  ...
                  >
                    ...
                    />
                    <Text style={[s.actionText, { color: ComeYaColors.error }]}>
                      Eliminar
                    </Text>
                  </Pressable>
                </View>
