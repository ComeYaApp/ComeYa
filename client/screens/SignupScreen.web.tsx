...
const ROLES = [
  {
    ...
    label: "Cliente",
    icon: "user",
    desc: "Pide comida y productos",
  },
  {
    value: "business_owner",
    label: "Negocio",
    icon: "briefcase",
    desc: "Vende tus productos",
  },
  {
    value: "delivery_driver",
    label: "Repartidor",
    icon: "truck",
    desc: "Entrega pedidos",
  },
];
...
export default function SignupScreen({ navigation, route }: Props) {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      const formatted = digits.startsWith("58")
        ? `+${digits}`
          ...
          <View style={s.leftInner}>
            ...
            {!isMobile && (
              <>
                ...
                <Text style={s.sub}>
                  Miles de usuarios ya disfrutan de ComeYa en Soria
                </Text>
            ...
            {isMobile && (
              <Text style={s.mobileTagline}>Únete a la comunidad 🍔</Text>
            )}
          </View>
        </View>
            ...
            <View style={s.formCard}>
                ...
                {ROLES.map((r) => (
                  ...
                  >
                    <Feather
                      name={r.icon as any}
                      size={22}
                      color={role === r.value ? PRIMARY : "#666"}
                    />
                    <Text
                      style={[
                        s.roleLabel,
                        role === r.value && { color: PRIMARY },
                      ]}
                    >
                      {r.label}
                    </Text>
              ...
              <View style={s.field}>
                ...
                <View style={s.inputRow}>
                  <View style={s.prefix}>
                    <Text style={s.prefixText}>🇪🇸 +34</Text>
                  </View>
                  <TextInput
                    style={s.input}
              ...
              <Text style={s.legal}>
                ...
                <Text style={s.legalLink}>Términos de Servicio</Text> y{" "}
